...
![Activate plugin!](https://resources.coinsnap.org/products/woocommerce/images/screenshot-2.png)
...
![Now you need to fill the fields „Coinsnap Store ID“ and „Coinsnap API Key“](https://resources.coinsnap.org/products/woocommerce/images/screenshot-4.png)
...
![You find these data in your Coinsnap backend](https://resources.coinsnap.org/products/woocommerce/images/screenshot-5.png)
...
![Add these strings in fields 2 and 3, respectively](https://resources.coinsnap.org/products/woocommerce/images/screenshot-6.png)
...
![Go to „Payments“ tab in the WooCommerce settings to activate Bitcoin payment (1)](https://resources.coinsnap.org/products/woocommerce/images/screenshot-7.png)
...
![Customize the checkout process according to your needs](https://resources.coinsnap.org/products/woocommerce/images/screenshot-8.png)
...
![Bitcoin payment activated](https://resources.coinsnap.org/products/woocommerce/images/screenshot-9.png)

### YOU ARE SET TO SELL FOR BITCOIN NOW! To be sure all works fine, you should now…

![Coinsnap plugin connected](https://resources.coinsnap.org/products/woocommerce/images/screenshot-10.png)
...
![QR code on the Bitcoin payment page](https://resources.coinsnap.org/products/woocommerce/images/screenshot-12.png)
...
#### 1.7.2 :: 2025-12-23
* Update: Connection status message left on settings page only.
* Update: Bitcoin discount output logic.
* Updated PHP files protection.
* Compatibility with WooCommerce 10.4.3 is tested.
