	...
	public function gatewayFormFields(
		...
		$this->form_fields = [
			'title' => [
				...
				'default'     => __('Bitcoin + Lightning', 'coinsnap-for-woocommerce'),
				'desc_tip'    => true,
			],
			'description' => [
				...
				'default'     => __('You will be redirected to the Bitcoin-Lightning Payment Page to complete your purchase.', 'coinsnap-for-woocommerce'),
				'desc_tip'    => true,
			],
		];
